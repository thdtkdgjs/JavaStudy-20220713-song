...
public class Method1 {
	...
	public static void main(String[] args) {
		...
		String data2 = "@Message:안녕하세요2.@To:김준일2@From:김준이2@SendDate:2022/07/21";
		String data3 = "@Message:안녕하세요3.@To:김준일3@From:김준이3@SendDate:2022/07/21";
		
		printData("@Message:안녕하세요.@To:김준일@From:김준이@SendDate:2022/07/21");
		printData(data2);
		printData(data3);
	}
